  ...
  <div class="content-wrapper">
    ...
    @include("componentes.encabezado",['titulo'=>'Editar Album'])
    ...
    <section class="content">
      ...
      @csrf
      <div class="card">
        @include("componentes.encabezadotarjeta",['titulo'=>'Editar Album'])
        <div class="card-body">
          <div class="form-group">
            <label for="exampleInputEmail1">AlbumId</label>
            <input type="text" class="form-control" id="AlbumId" name="AlbumId" readonly value="{{$album->AlbumId}}" >
          </div>
          <div class="form-group">
          ...
          <div class="form-group">          
            ...
            <input type="text" class="form-control" id="ArtistId" name="ArtistId" value="{{$album->ArtistId}}">
          </div>
